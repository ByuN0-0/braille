    ...
    <div className="space-y-12">
      <section className="text-center space-y-4 py-10">
        ...
        <div className="flex justify-center gap-3">
          <Link href="/learn" className="px-5 py-2 rounded-lg border bg-black/[.05] dark:bg-white/[.06]">학습 시작</Link>
          <Link href="/table" className="px-5 py-2 rounded-lg border">점자표</Link>
        </div>
      </section>

      <section className="rounded-2xl border p-6 bg-gradient-to-b from-black/[.02] to-transparent dark:from-white/[.04]">
